...
void CreateRS01EWindow(Method *method, GtkWidget *parent) {
  ...
  g_signal_connect(G_OBJECT(wl->curveButton), "clicked",
                   G_CALLBACK(curve_button_cb), NULL);
...
void RS01SetFixMaxValues(RS01Widgets *wl, int data_bytes, int ecc_bytes,
                         gint64 sectors) {
...
void RS01UpdateFixResults(RS01Widgets *wl, gint64 corrected,
                          gint64 uncorrected) {
